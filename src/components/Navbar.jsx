    ...
    {/* <span className="text-blue-400 text-2xl"></span> */}
      ...
      <nav className=" bg-gray-800 p-4 flex justify-between items-center ">
        <div className=" flex items-center flex">
          <img src="/ChatGPT Image Aug 3, 2025, 11_43_27 AM.png" className="text-2xl mr-[-5px]" style={{marginTop:'-10px', rotate:'-10deg', height:'60px', color: '#ffffffff', fontSize: '23px', marginLeft: '20px'}} />
