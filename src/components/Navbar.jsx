    ...
    {/* <span className="text-blue-400 text-2xl"></span> */}
      ...
      <nav className=" bg-gray-800 p-4 flex justify-between items-center ">
        <div className=" flex items-center flex">
          <img src={process.env.PUBLIC_URL + "/public/ChatGPT Image Aug 3, 2025, 11_43_27 AM.png"} className="text-2xl mr-[-5px]" style={{marginTop:'-10px', rotate:'-10deg', height:'60px', color: '#ffffffff', fontSize: '23px', marginLeft: '20px'}} />
        ...
        <div className="sm:hidden ">
         ...
         style={{transition:'ease-in-out'}}  >
            <FaBarsStaggered className="text-2xl" />
                ...
                {menuOpen && (
        <div className="sm:hidden bg-gray-500 px-4 py-2 space-y-2 flex flex-col justify-center items-center z-index-50 duration-700" style={{ height:' 300px', position: 'absolute', top: '90px', right: '0', width: '100%', backgroundColor: '#1f2937', zIndex:'2', boxShadow: '0 4px 6px rgba(0, 0, 0, 0.1)', borderRadius: '8px'
         }}> 
