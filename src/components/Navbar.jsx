    ...
    <>
      ...
      <nav className=" bg-gray-800 p-4 flex justify-between items-center ">
        <div className=" flex items-center flex">
          <img src={`${import.meta.env.BASE_URL}ChatGPT.png`} className="text-2xl mr-[-5px]" style={{ marginTop: '-10px', rotate: '-10deg', height: '60px', color: '#ffffffff', fontSize: '23px', marginLeft: '20px' }} />
