        ...
        <section className='s3 bg-sky-200'>
            ...
            <p className='text-center'>Discover the rich culture, stunning landscapes, and vibrant traditions of India. From the majestic Himalayas to the serene backwaters of Kerala, embark on a journey that will leave you mesmerized.</p>
             ...
             <div className='d-flex justify-content-around flex-wrap'>
                ...
                <img src="/indian-temple-4782290_1920.jpg" className="card-img-top" alt="..." />
            ...
            <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/Radha-Rani-Mandir-Barsana-Timings.webp" className="card-img-top" alt="..." />
                    <div className="card-body">
            ...
            <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/Krishna_Janmabhoomi_Temple_Mathura.jpg" className="card-img-top" alt="..." />
                    <div className="card-body">
             ...
             <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/temple-courtyard.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
           ...
           <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/hawa-mahal-6973938_1920.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
             ...
             <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/kishangarh-6511349_1920.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
             ...
             <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/four-seasons-2083680_1280.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
             ...
             <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/desert-6041013_1920.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
             ...
             <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/tungnath-6103961_1920.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
              ...
              <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/majuli-4203237_1280.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
              ...
              <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/unnamed.webp" className="card-img-top hello" alt="..." />
                    <div className="card-body">
              ...
              <div className="card" style={{ width: "22rem", height: "25rem" }}>
                <img src="/milky-way-8153503_1920.jpg" className="card-img-top hello" alt="..." />
                    <div className="card-body">
